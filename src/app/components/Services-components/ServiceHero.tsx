    ...
    return (
        <div>
            ...
            >
                ...
                >
                    <img
                        ...
                        alt="Jennywealth Events Services"
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white p-4 z-10">
                    ...
                    {/* Animated underline - reduced delay */}
                    <motion.div
            ...
            <motion.div
                ...
                transition={{ duration: 0.6, delay: 0.4 }} // Reduced from 0.8, 0.5
            >
                <div className="max-w-4xl mx-auto px-4">
                    <motion.h2
                        ...
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.6, delay: 0.6 }} // Reduced from 0.8, 0.8
                    >
                        Service Offerings
                    </motion.h2>
                    <motion.p
                        ...
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.6, delay: 0.8 }} // Reduced from 0.8, 1.1
                    >
                        A Tailored event planning from concept to execution, we
